...
//action of building renovation		
	action renovation_action{
		...
		reflex update_status {
			...
			//amount of renovated buildings for every year
			
			//development of heating systems: count the amount of different heating systems for every year
			
			//count the total hwb/heb
			//loop x over: list(renovation_status_actual)
			
			
			//i <- count where(is_renovated=true);
//		
//		loop while: inside_dhp{
//			ab <- ab+total_hwb_actual;
//		}
		}
