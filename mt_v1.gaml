...
global {
    ...
    geometry building_shape <- envelope(envelope(building_polygons) + envelope(dh_network_gleisdorf) + envelope(gas_network_gleisdorf)
...
// definition of attributes///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    int pot_matching <- 0; //for the matching building and potential zone
...
geometry potential_shape <-  geometry(dh_potential_gleisdorf); 
reflex a {
		if building_shape intersects potential_shape{
		do die;
	}
}
...
//		ask potentials intersects buildings{
//		 
//				write "hallo";
//			}
//		 
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//species cild parent:potentials
		species dh_potential parent:potentials {
	...
	species gas_potential parent:potentials{
...
experiment renovation type:gui /* + specify the type : "type:gui" or "type:batch" */
{
    ...
    output {
        ...
        display gleisdorf type: opengl {
        	...
        	species buildings aspect: type_aspect;//actual_renovation_status; //renovation_aspect;//heat_type;
        	species dh_network;
        	species gas_network;
        	
        	//species my_people aspect: base;
